let dark = false;
    ...
    function lightTheme()
    {
        ...
        cssStyleSheet.href = "asset/css/style.css";
            document.getElementById("header_logo").src = "asset/img/logo.png";
    ...
    function darkTheme(){
        ...
        let path = (cssStyleSheet.href).substring((cssStyleSheet.href).length-9, (cssStyleSheet.href).length);
            ...
            cssStyleSheet.href = "asset/css/style_dark.css";
            document.getElementById("header_logo").src = "asset/img/logo_dark.png";
